...
public class FirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView date = (TextView) findViewById(R.id.LabelDate1);
        data = getSharedPreferences("DataStore", Context.MODE_PRIVATE);
        String date1 = data.getString("date1",null);
        date.setText("1日目　"+ date1);

        sHelper = new ScheduleDbHelper(this);
        mScheduleListView = (ListView) findViewById(R.id.list_firstDay);
    ...
    public void upDateUI(){
        data = getSharedPreferences("DataStore", Context.MODE_PRIVATE);
        String date = data.getString("date1",null);
        ...
        if(date!=null) {
            ...
            while (cursor.moveToNext()) {
                ...
                if(cursor.getString(idx).length()<1||cursor.getString(idx2).length()<1)continue;
